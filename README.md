...
Выведя средний щначения по коррелляциям, я классифицировал факторы фрода для того, чтобы обратить внимания на те факторы, которые сильно влияют на совершение фрода клиентами банка.
...
<img src="plot.png" alt="plot.png" width="200"/>
